...
const PRODUCTS = [
  ...
  { id:10, name:'ORRO Sheet', category:'wall', material:'pvc', application:'residential', img:'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&q=80&auto=format', features:['High Gloss Finish','Premium Quality','Scratch Resistant','Easy Installation'] },
  { id:11, name:'PU Stone', category:'wall', material:'pvc', application:'residential', img:'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=400&q=80&auto=format', features:['Natural Stone Look','Lightweight','Textured Surface','Easy Application'] },
  { id:12, name:'Wallpaper', category:'decor', material:'vinyl', application:'residential', img:'https://images.unsplash.com/photo-1615800098779-1be32e60cca3?w=400&q=80&auto=format', features:['Various Patterns','Peel & Stick','Washable','Wide Variety'] },
  { id:13, name:'Custom Wallpaper', category:'decor', material:'vinyl', application:'residential', img:'https://images.unsplash.com/photo-1615800098779-1be32e60cca3?w=400&q=80&auto=format', features:['Custom Design','High Quality Print','Durable','Easy Replace'] },
  { id:14, name:'Roller Blind', category:'decor', material:'fabric', application:'residential', img:'https://images.unsplash.com/photo-1615873968403-89e068629265?w=400&q=80&auto=format', features:['Blackout Options','UV Protection','Custom Sizes','Smooth Operation'] },
  { id:15, name:'Zebra Blind', category:'decor', material:'fabric', application:'residential', img:'https://images.unsplash.com/photo-1631679706909-1844bbd07221?w=400&q=80&auto=format', features:['Day & Night Control','Light Filtering','Modern Design','Custom Sizes'] },
  { id:16, name:'Arctic Pastel Grass', category:'exterior', material:'synthetic', application:'outdoor', img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80&auto=format', features:['UV Resistant','Soft Texture','Low Maintenance','Natural Appearance'] },
  { id:17, name:'PVC Carpet', category:'flooring', material:'pvc', application:'commercial', img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80&auto=format', features:['Easy Clean','Water Resistant','Anti-Slip','Durable'] },
  { id:18, name:'Wooden Flooring', category:'flooring', material:'wood', application:'residential', img:'https://images.unsplash.com/photo-1565538810643-b5bdb714032a?w=400&q=80&auto=format', features:['Natural Wood','Engineered','Various Species','Click Lock System'] },
  { id:19, name:'PVC Carpet - 4 MM', category:'flooring', material:'pvc', application:'commercial', img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80&auto=format', features:['4mm Thickness','Extra Durable','Enhanced Comfort','Superior Grip'] },
  { id:20, name:'Glass Film', category:'decor', material:'vinyl', application:'commercial', img:'https://images.unsplash.com/photo-1497366216548-37526070297c?w=400&q=80&auto=format', features:['Frosted Options','Privacy Protection','UV Blocking','Easy Application'] },
  { id:21, name:'Soffit Panel', category:'exterior', material:'pvc', application:'outdoor', img:'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=400&q=80&auto=format', features:['Weather Resistant','Vented Options','Easy Installation','Multiple Colors'] },
  { id:22, name:'PVC Flooring', category:'flooring', material:'pvc', application:'commercial', img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80&auto=format', features:['100% Waterproof','Easy Maintenance','Anti-Skid','Cost Effective'] },
  { id:23, name:'Artificial Grass', category:'exterior', material:'synthetic', application:'outdoor', img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80&auto=format', features:['UV Resistant','Low Maintenance','Natural Look','Various Pile Heights'] },
];
