...
==========================================*/
const PRODUCTS = [
  { id:1, name:'Standard PVC Wall Panels', category:'wall', material:'pvc', application:'residential', img:'https://images.unsplash.com/photo-1615800098779-1be32e60cca3?w=400&q=80&auto=format', features:['Waterproof','Anti-Fungal','Lightweight','5–10mm thick'] },
  { id:2, name:'Assa Premium Panels', category:'wall', material:'pvc', application:'residential', img:'https://images.unsplash.com/photo-1631679706909-1844bbd07221?w=400&q=80&auto=format', features:['Premium Finish','Zero Joints','UV Coated','10mm'] },
  { id:3, name:'ORRO Sheets', category:'wall', material:'pvc', application:'residential', img:'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&q=80&auto=format', features:['High Gloss','Scratch Resist','Easy Install','8mm'] },
  { id:4, name:'WPC Fluted Panels', category:'wall', material:'wpc', application:'residential', img:'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=400&q=80&auto=format', features:['3D Texture','Impact Resistant','Acoustic','12–24mm'] },
  { id:5, name:'Charcoal Louvers', category:'wall', material:'wpc', application:'residential', img:'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=400&q=80&auto=format', features:['Deep Matte','Eco-Friendly','Bamboo Charcoal','300mm width'] },
  { id:6, name:'UV Marble Sheets', category:'wall', material:'pvc', application:'residential', img:'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=400&q=80&auto=format', features:['High Gloss','Seamless','Scratch Resist','4×8ft sheet'] },
  { id:7, name:'PU Stone Panels', category:'wall', material:'pvc', application:'residential', img:'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=400&q=80&auto=format', features:['Natural Look','Lightweight','Easy Fix','Various textures'] },
  { id:8, name:'French Molding', category:'wall', material:'pvc', application:'residential', img:'https://images.unsplash.com/photo-1600210492493-0946911123ea?w=400&q=80&auto=format', features:['Decorative','Classic Design','PVC','Various profiles'] },
  { id:9, name:'PVC Grid Ceiling', category:'ceiling', material:'pvc', application:'commercial', img:'https://images.unsplash.com/photo-1497366216548-37526070297c?w=400&q=80&auto=format', features:['Commercial Grade','Easy Access','Conceals Wiring','2×2ft tiles'] },
  { id:10, name:'Interlocking PVC Ceiling', category:'ceiling', material:'pvc', application:'residential', img:'https://images.unsplash.com/photo-1600121848594-d8644e57abab?w=400&q=80&auto=format', features:['Seamless','100% Waterproof','Reflective','Easy Install'] },
  { id:11, name:'PVC Vinyl Roll Flooring', category:'flooring', material:'vinyl', application:'commercial', img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80&auto=format', features:['Anti-Skid','Water Resist','Easy Clean','1.5mm thick'] },
  { id:12, name:'Luxury Vinyl Tiles (LVT)', category:'flooring', material:'vinyl', application:'residential', img:'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=400&q=80&auto=format', features:['Wood Mimicry','4–6mm','0.5mm wear layer','Rigid Core'] },
  { id:13, name:'Wooden Flooring', category:'flooring', material:'wood', application:'residential', img:'https://images.unsplash.com/photo-1565538810643-b5bdb714032a?w=400&q=80&auto=format', features:['Natural Wood','Engineered','Various species','Click lock'] },
  { id:14, name:'Custom Wallpaper', category:'decor', material:'vinyl', application:'residential', img:'https://images.unsplash.com/photo-1615800098779-1be32e60cca3?w=400&q=80&auto=format', features:['Custom Print','Peel & Stick','Various Textures','Easy Replace'] },
  { id:15, name:'Roller Blinds', category:'decor', material:'fabric', application:'residential', img:'https://images.unsplash.com/photo-1615873968403-89e068629265?w=400&q=80&auto=format', features:['Blackout Options','UV Protection','Custom Sizes','Motorized Option'] },
  { id:16, name:'Zebra Blinds', category:'decor', material:'fabric', application:'residential', img:'https://images.unsplash.com/photo-1631679706909-1844bbd07221?w=400&q=80&auto=format', features:['Day & Night','Light Control','Modern Design','Custom Sizes'] },
  { id:17, name:'Artificial Grass', category:'exterior', material:'synthetic', application:'outdoor', img:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80&auto=format', features:['UV Resistant','Low Maintenance','Natural Look','Various pile heights'] },
  { id:18, name:'Soffit Panels', category:'exterior', material:'pvc', application:'outdoor', img:'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=400&q=80&auto=format', features:['Weather Resistant','Vented Options','Easy Install','Various colors'] },
  { id:19, name:'Mosaic Tiles', category:'wall', material:'glass', application:'residential', img:'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&q=80&auto=format', features:['Decorative','Vibrant Colors','Bathroom Safe','Various patterns'] },
  { id:20, name:'Glass Film', category:'decor', material:'vinyl', application:'commercial', img:'https://images.unsplash.com/photo-1497366216548-37526070297c?w=400&q=80&auto=format', features:['Frosted Options','Privacy','UV Block','Easy Apply'] },
];
